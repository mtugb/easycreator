...
export const ecrItems = {
    ...
    'ecr:pole': {
        ...
        onBreakBlock_after: (e) => {
            ...
            e.dimension.fillBlocks(new BlockVolume({ x: e.block.location.x, y: e.block.location.y + 1, z: e.block.location.z }, { x: e.block.location.x, y: e.block.location.y + height, z: e.block.location.z }), clipboard_block);
        }
    },
    'ecr:spoit': {
        name: 'スポイト',
    ...
    'ecr:circle_empty': {
        ...
        onBreakBlock_after(e) {
            ...
            showForm(e.player, 'circle_create', (player, result) => {
                if (result.canceled) {
                    return;
                }
        ...
        onBreakBlock_after: (e) => {
            ...
            if (ecrTag == null) {
                ...
                if (xyz) {
                    ...
                    const nanamePotantials = new Set();
...
function setEndPosBlock(location, dimension) {
